...
export const ja: PortfolioContent = {
  ...
  about: { label: '01 / Kaiについて', title: '10年以上、音楽を通じて人と出会ってきました。', paragraphs: ['Kaiはバンドギタリストであり、音楽交流ナビゲーターです。10年以上にわたり、バンド演奏、オリジナル楽曲制作、音楽フェスや交流活動に参加。台湾各地のLive Houseや公開イベントで、さまざまな文化背景を持つ仲間と出会ってきました。', '一曲を弾けるようになることも大切ですが、一緒に音楽を楽しめる仲間との出会いこそ、音楽を暮らしに根づかせてくれます。成人学習者に合った練習方法、バンド仲間、音楽コミュニティとの出会いをサポートします。'], image: { src: '/images/about.webp', alt: '暮らしの空間で自然にギターを楽しむ様子' }, facts: [{ value: '10年以上', label: 'バンド演奏・音楽制作' }, { value: '2年以上', label: '大人向けギター指導' }, { value: '日 × 台', label: '音楽文化交流ネットワーク' }] },
  services: { label: '02 / サポート', title: '自分に合った入口から、音楽のある暮らしへ', intro: 'ギターや音楽理論から、バンドマッチング、Jam Session、日本の音楽文化体験まで。経験、興味、目標を伺い、長く続けられる方法を一緒に探します。', items: [{ number: '01', title: '音楽学習とバンド育成', description: 'ギター入門、基礎理論、機材選び、楽曲分析、個別練習プランを通して、社会人の音楽習慣づくりを支えます。' }, { number: '02', title: 'バンドマッチングと音楽交流', description: 'バンド運営の経験を共有し、メンバー探し、音楽コミュニティ、交流イベントとの出会いをつなぎます。' }, { number: '03', title: '日台音楽文化と音楽旅行', description: '日本の音楽フェス、Live House、Music Bar、Jam Sessionの体験をもとに、台湾の音楽家を日本の現場へ案内します。' }] },
  projects: { label: '02 / ポートフォリオ', title: '音楽から生まれたプロジェクトと出会い', intro: 'バンド制作、コミュニティ企画、日台文化交流。一つひとつの経験が次の協働へつながっています。', items: [
    { title: 'MI Tokyo Open Campus', description: '日本の音楽学校のOpen Campusで、現地ミュージシャンとリハーサル・演奏を行い、音楽教育と国際協働を体験しました。', tags: ['日本音楽交流', 'MI Tokyo', '国際協働'] },
    { title: '日台ミュージシャン Jam Session', description: '在日台湾ミュージシャンや多様な仲間と即興演奏を行い、文化を越えたつながりを広げました。', tags: ['Jam Session', '音楽コミュニティ', '日台交流'] },
    { title: 'エンジニア音楽コミュニティと音楽祭', description: '科学園区音楽祭の企画運営に参加し、社会人ミュージシャンとバンドをつなぐ場を育てました。', tags: ['イベント企画', 'コミュニティ', '音楽祭'] },
    { title: 'Co-Writing 音楽制作キャンプ受賞作品', description: '異なる分野の音楽家と共作し、オリジナル作品を完成。審査員から評価をいただきました。', tags: ['オリジナル音楽', '共創', '受賞作品'], link: 'https://www.youtube.com/watch?v=a688LNEiHsM' },
    { title: '初耳 Hatsumimi 日台文化交流', description: 'TAIWAN PLUSと初耳の活動で、日中コミュニケーションとイベント運営の橋渡しを行いました。', tags: ['ボランティア', '文化交流', '台湾祭'] },
    { title: 'オリジナルバンド録音作品', description: 'バンドでの制作から録音まで、音楽のアイデアを保存し共有できる作品へ仕上げました。', tags: ['バンド制作', 'インディーズ', 'レコーディング'], link: 'https://linktr.ee/mr_recycle' }
  ] },
  ...
  process: { label: '05 / サービスの流れ', title: 'あなたを知ることから、音楽のある暮らしへ', items: [
  ...
  vision: { label: '05 / Music Community OS', quote: '音楽を暮らしの一部に。そして、人と人が出会う理由に。', title: '音楽習慣、仲間、文化交流が続いていく仕組み', description: 'Music Community OSは、音楽学習、バンドマッチング、イベント参加、日台文化交流をつなぎます。一人ひとりの経験、興味、目標を知ることから始め、適した学びと交流を提案。自分らしい音楽ライフを育て、都市や文化を越えて音楽家同士が出会える環境を目指します。' },
  contact: { label: '06 / お問い合わせ', title: '自分に合った音楽の入口を見つけよう。', description: 'ギターを始めたい、練習習慣をつくりたい、バンド仲間を探したい、日本のLive HouseやJam Sessionを体験したい。まずは経験、興味、目標を聞かせてください。', email: 'narumi1001@gmail.com', emailLabel: 'narumi1001@gmail.com', socialLinks: [{ label: 'Instagram', href: 'https://www.instagram.com/balance_liao' }, { label: 'Linktree', href: 'https://linktr.ee/balanceliao' }, { label: 'YouTube', href: 'https://www.youtube.com/watch?v=a688LNEiHsM' }] },
