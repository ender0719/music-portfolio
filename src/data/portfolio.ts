...
export interface PortfolioContent {
  ...
  about: { label: string; title: string; paragraphs: readonly string[]; story: string; image: ImageAsset; facts: readonly { value: string; label: string }[]; timeline: readonly { label: string; title: string; description: string }[] };
  currently: { label: string; title: string; intro: string; items: readonly { status: string; title: string; description: string }[] };
  values: { label: string; title: string; intro: string; items: readonly { number: string; title: string; description: string }[] };
  services: { label: string; title: string; intro: string; items: readonly { number: string; status: string; title: string; description: string; audience: string; action: { label: string; href: string }; image: ImageAsset }[] };
