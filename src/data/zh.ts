...
export const zh: PortfolioContent = {
  ...
  projects: { label: '02 / 代表作品', title: '因音樂而發生的計畫與相遇', intro: '從樂團創作、社群活動到台日文化交流，每一項作品都累積了下一段合作的經驗。', items: [
    ...
    { title: '初耳 Hatsumimi 台日文化交流', description: '參與 TAIWAN PLUS 與初耳活動，擔任中日溝通與活動引導的橋樑。', tags: ['志工服務', '文化交流', '台灣祭'], image: { src: '/images/projects/hatsumimi.webp', alt: '初耳 Hatsumimi 台日文化交流活動照片' } }
  ] },
